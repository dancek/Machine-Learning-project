...
system(['./bmix-1.11/bin/bmix_like --data data/validation' id ...
    '.data --model-in models/train_ham' id '.model -s > data/ham_likelihoods' id '.txt']);
system(['./bmix-1.11/bin/bmix_like --data data/validation' id ...
    '.data --model-in models/train_spam' id '.model -s > data/spam_likelihoods' id '.txt']);
